...
**Goal:** Merge raw downloads into **one visualization-ready “source of truth”** (country–year table with gender split + growth metrics).
...
1) **Align keys** (unique country–year): `Entity`, `Code` (ISO-3), `Year`  
2) **Join** total + male on the keys (same country + same year)  
