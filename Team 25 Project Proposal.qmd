...
- **Identification of outlier countries**  
  Finally, we will identify countries with **unusually high or low** gender imbalance compared to others in the same region, and discuss possible explanations (e.g., migration, policy, or social factors). These outliers will be highlighted in both the choropleth and the line chart to connect the analysis back to the visualizations.
